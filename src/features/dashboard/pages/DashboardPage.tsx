...
const DashboardPage = () => {
  return (
    <div className="relative space-y-8 pb-8">
      ...
      {/* Header */}
      <div className="animate-in fade-in-0 slide-in-from-top-2 rounded-2xl border border-border/70 bg-card/60 p-5 backdrop-blur-sm duration-500 md:p-6 dark:border-white/10 dark:bg-card/50">
